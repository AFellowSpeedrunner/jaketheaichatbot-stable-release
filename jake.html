...
<HTML><HEAD>
<META NAME="About the chatbot Jake" CONTENT="Jake">
<TITLE>Jake</TITLE>
...
// Wait function to allow our pieces to get here prior to starting
	...
	function hello(){
		chatter[chatpoint] = "> Hello, I am Jake.";
		chatpoint = 1;
		return write();
	}
	function start(){
...
// And to give the illusion that some thinking is going on
	...
	function dialog(){
		...
		setTimeout("think()", 0000 + Math.random()*800);
		chatpoint ++ ;
...
<h1>Jake: A revamp of the Eliza chatbot.</h1>
...
<table cellspacing="0" cellpadding="2" border="0" align="center" class="neurotoy">
	<tr><th bgcolor=#ffffff align="left">
		<font color="#00000">Talk to Jake by typing your questions and answers in the input box.</Font>
  </td></tr>
